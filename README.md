...
1) Sir Squirrel only works for 1920x1080p Resolution. Either Borderless Fullscreen(Recommended) or Windowed
    ...
    * If you are on a higher resolution than 1080P, you can still use sir squirrel. Just simply change the resolution to windowed 1080p and move the windows such that the top left corner is at the top left of your monitor
